...
describe('Verified', () => {
    it('Gets, types and asserts', () => {
     ...
     cy.wait(5500)
      ...
      cy.wait(3000)
      cy.contains('CEX.IO Wallet').click()
      cy.get("input", { timeout: 25000 }).type('20', { timeout: 25000 })  // ввод размера пополнения счета
      cy.wait(1000)
      cy.contains('Make a Transfer', { timeout: 25000 }).click()// нажать Make a transfer
      cy.wait(30000)
      cy.contains('Go Trade').click({ timeout: 25000 })
      ...
      cy.wait(3000)
      cy.contains("ua201536245_CY", { timeout: 25000 }).trigger('mouseover', { timeout: 25000 }) //наведение мыши на список действий аккаунта
